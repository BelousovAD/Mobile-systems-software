    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonDarkBlue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ((Branch) activity).fragmentMail(R.string.dark_blue, R.color.dark_blue);
        ...
        buttonDarkGrey.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ((Branch) activity).fragmentMail(R.string.dark_grey, R.color.dark_grey);
                } catch (ClassCastException ignored) {}
            }
        });
        buttonDarkPurple.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ((Branch) activity).fragmentMail(R.string.dark_purple, R.color.dark_purple);
                } catch (ClassCastException ignored) {}
            }
        });
